...
<body>
   ...
   <form method = "post" action = "process.jsp">
      ...
      <table>  
         ...
         <tr>
            <td class = "right bold">Broj indeksa:</td>

            <td>
               <input type = "text" name = "brojIndeksa" 
                  size = "25" />
            </td>
         </tr>

         <tr>
            <td class = "right bold">Smer :</td>

            <td>
               
                  <input type = "text" name = "smer" size = "25" />
         ...
         <tr>
            <td class = "right bold">Skolska godina:</td>

            <td>
               <input type = "text" name = "skolskaGodina" 
                  size = "25" />  
            </td>
         </tr>
      ...
      <p><input type = "submit" value = "addStudent" /></p>
   </form>
</body>
